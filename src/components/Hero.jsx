...
const RECENT_SEARCHES = [
 ...
 { from: 'Ahmedabad', to: 'Mumbai', date: 'Daily', icon: '', price: '₹420', badge: ' AC' },
 { from: 'Hyderabad', to: 'Bangalore', date: 'Tue 23 Sep', icon: '', price: '₹799', badge: ' Sleeper' },
 ...
 { from: 'Lucknow', to: 'Delhi', date: 'Today', icon: '', price: '₹580', badge: ' 7h' },
...
const Hero = () => {
 ...
 <span className={styles.calendarMiniIconRight}></span>
 <input
