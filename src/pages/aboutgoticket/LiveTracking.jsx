...
const LiveTracking = () => {
 ...
 Per verified Indian transit standards, GoTicket does not generate simulated or fabricated coordinates.
 </div>
 </div>
 )}
 ...
 No bus found for <strong>"{searchInput}"</strong>. Try searching by vehicle registration (e.g. DL1PC..., UP32...) or PNR.
 </div>
 )}
